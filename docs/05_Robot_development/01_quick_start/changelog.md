...
- 新增[DeepSeek大语言模型](/docs/05_Robot_development/03_boxs/generate/hobot_xlm.md)算法示例。支持人机对话；`RDK S100` 新增支持 `DeepSeek_R1_Distill_Qwen_1.5B` 模型；`RDK S100P` 新增支持 `DeepSeek_R1_Distill_Qwen_1.5B`, `DeepSeek_R1_Distill_Qwen_7B` 模型。

...
| 算法版本      | 算法特性                                                                  |
| ------------- | ------------------------------------------------------------------------- |
| X5 V2.0       | int16量化，精度较高、帧率较低，最高输出15FPS分辨率640*352的深度图         |
| X5 V2.1       | int16量化，有置信度输出，最高输出15FPS分辨率640*352的深度图               |
| X5 V2.2       | int8量化，精度较低、帧率较高，最高输出23FPS分辨率640*352的深度图          |
| X5 V2.3       | int8量化，帧率进一步提升，最高输出27FPS分辨率640*352的深度图              |
| X5 V2.4 int16 | int16量化，加入更多数据训练，最高输出15FPS分辨率640*352的深度图           |
| X5 V2.4 int8  | V2.4的int8量化版本，最高输出23FPS分辨率640*352的深度图                    |
| S100 V2.1     | int16量化，有置信度输出，最高输出53FPS分辨率640*352的深度图               |
| S100 V2.4     | int16量化，有置信度输出，加入更多数据训练，输出53FPS分辨率640*352的深度图 |

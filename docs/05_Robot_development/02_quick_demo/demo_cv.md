...
| RDK X5| Ubuntu 22.04 (Humble) | 读取图片，进行抠图 |
| RDK S100| Ubuntu 22.04 (Humble) | 读取图片，进行抠图 |
...
| 平台    | 运行方式      | 示例功能                       |
| ------- | ------------- | ------------------------------ |
| RDK X5| Ubuntu 22.04 (Humble) | nv12,gbr24之间的转换 |
| RDK S100| Ubuntu 22.04 (Humble) | nv12,gbr24之间的转换 |

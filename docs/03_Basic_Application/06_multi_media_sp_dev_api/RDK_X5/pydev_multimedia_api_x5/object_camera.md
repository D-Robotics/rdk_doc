...
Camera 对象用于完成 MIPI Camera 的图像采集和处理功能，包含了 `open_cam`、`open_vps`、`get_img`、`set_img`、`close_cam` 等几种方法。该模块封装在 hobot_vio 的 libsrcampy 中
...
## 参考示例
 Camera 对象部分示例代码可以参考 08_mipi_camera_sample 中的 01_mipi_camera_yolov5s.py 示例介绍

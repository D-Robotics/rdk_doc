...
## 示例简介
RTSP 流解码示例是一个位于 `/app/pydev_demo/08_decode_rtsp_stream/` 中的 **Python 接口** 开发代码示例，用于演示如何从 RTSP 视频流获取 H.264/H.265 码流，通过硬件解码、视频处理和 BPU 推理，实现实时视频解码和目标检测功能。该示例展示了完整的视频处理流水线，包括 RTSP 流接收、硬件解码、视频处理、推理和结果显示。

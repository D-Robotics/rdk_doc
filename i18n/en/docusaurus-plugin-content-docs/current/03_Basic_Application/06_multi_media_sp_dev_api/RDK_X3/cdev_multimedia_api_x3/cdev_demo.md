...
1. Power off the development board, connect the `MIPI` camera to the board. Refer to [Hardware Introduction - MIPI Interface](../../../../01_Quick_start/hardware_introduction/rdk_x5.md#mipi_port) for detailed connection instructions.
...
- **Environment Setup:**
   - With the development board powered off, connect the `MIPI` camera to the development board following the instructions in the [MIPI Camera Connection Tutorial](../../../../01_Quick_start/hardware_introduction/rdk_x3.md#mipi_port).
  - Connect the development board to the monitor using an HDMI cable.
  - Power on the development board and log in via the command line.

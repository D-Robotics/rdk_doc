...
手势识别算法集成了人手关键点检测，手势分析等技术，使得计算机能够将人的手势解读为对应指令，可实现手势控制以及手语翻译等功能，主要应用于智能家居，智能座舱、智能穿戴设备等领域。
...
1. 选择连接摄像头的类型，本章节以 MIPI 相机为例进行说明，点击对应的 `启动` 指令，等待节点运行，完成后自动打开可视化窗口进行识别，并将识别到的结果通过语音播报。
...
5. 点击 `Web Display`， 进入可视化页面实时识别手势。
...
![示例图片](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/rdk_studio/left_menu_example_application_gesture_update_package.png)

...
# 1.2.3.2 Bootloader (NAND) firmware flashing
...
RDK X5 Bootloader flashing on a PC uses **XBurn**.
...
- **Burning port to PC**: USB Type-C
- **Power**: USB Type-C with a **5V/5A** adapter

    <img 
          src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/install_os/install_os_260408/en/x5/NAND_install_connnect_port.png" 
          style={{ width: '100%', height: 'auto', align:'center'}}
    />
...
1. Set parameters:
    ...
    - **Serial port**: the port Windows/Linux sees
    - **Baud rate**: **115200** for RDK X5

        <img 
            src="http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/install_os/install_os_260408/en/x5/xburn_parameter_config.png" 
            style={{ width: '100%', height: 'auto', align:'center'}}
        />

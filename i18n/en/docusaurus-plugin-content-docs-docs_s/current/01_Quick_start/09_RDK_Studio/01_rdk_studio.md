...
# 1.7.1 Introduction to RDK Studio
...
- Includes a built-in app space for easily downloading and installing various applications.
  ...
  ![Device Management Card](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/rdk_studio/s100/device_manage_card_s100.png)
...
- All samples come pre-configured with environment adaptations and integrated dependencies, supporting rapid installation and execution.
    ...
    ![Sample Application List](http://rdk-doc.oss-cn-beijing.aliyuncs.com/doc/img/01_Quick_start/image/rdk_studio/en/app_display.png)

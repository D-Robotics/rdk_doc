...
const getCustomTitle = (permalink: string, locale: string): string | null => {
  const rules = {
    en: [
      ...
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_x3\/object_camera$/, title: 'Camera Object' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_x3\/object_encoder$/, title: 'Encoder Object' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_x3\/object_decoder$/, title: 'Decoder Object' },
      ...
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_ultra\/object_encoder$/, title: 'Encoder Object' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_ultra\/object_decoder$/, title: 'Decoder Object' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/pydev_multimedia_api_ultra\/object_display$/, title: 'Display Object' },

      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/cdev_multimedia_api_ultra\/vio_api$/, title: 'VIO (Video Input/Output) API' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/cdev_multimedia_api_ultra\/encoder_api$/, title: 'ENCODER（Encoding Module）API' },
      { pattern: /^\/rdk_doc\/en\/Basic_Application\/multi_media_sp_dev_api\/multi_media_api\/cdev_multimedia_api_ultra\/decoder_api$/, title: 'DECODER（Decoding Module）API' },

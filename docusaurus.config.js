      ...
      announcementBar: {
        ...
        content: (() => {
          if (process.env.DOCUSAURUS_CURRENT_LOCALE === "en") {
            return 'The content of this manual has been migrated to the <a class="announcement-bar-link" href="https://developer.d-robotics.cc/rdk_doc_center/en" target="_blank" rel="noopener noreferrer">new resource center</a>. This page will be archived and no longer maintained starting June 8, 2026.';
          }
          return '本手册内容已迁移至全新的<a class="announcement-bar-link" href="https://developer.d-robotics.cc/rdk_doc_center/" target="_blank" rel="noopener noreferrer">资料中心</a>，此页面于 2026 年 6 月 8 日起进入归档状态，停止维护。';
        })(),
